...
public class Program
{
    ...
    private unsafe static void Main(string[] args)
    {
        ...
        // --------------------------------------------------
        Shader shader = new Shader(_gl, "src/default.vs", "src/default.fs");
        Shader normalShader = new Shader(_gl, "src/normal_visualization.vs", "src/normal_visualization.fs", "src/normal_visualization.gs");
        
        // carregar modelos
        // --------------------------------------------------
        StbImage.stbi_set_flip_vertically_on_load(1);
        Model backpack = new Model(_gl, "res/objects/backpack/backpack.obj");

...
public class Program
{
    ...
    private static Atmospheres _atmospher = Atmospheres.DESERT;
    ...
    private unsafe static void Main(string[] args)
    {
        ...
        // --------------------------------------------------
        Shader lightingShader = new Shader(_gl, "src/multiple_lights.vs", "src/multiple_lights.fs");
        ...
        while (!_glfw.WindowShouldClose(window))
        {
            ...
            */
            ...
            if (_atmospher == Atmospheres.DESERT)
            {
            ...
            if (_atmospher == Atmospheres.FACTORY)
            {
                _gl.ClearColor(0.1f, 0.1f, 0.1f, 1.0f);
            ...
            if (_atmospher == Atmospheres.HORROR)
            {
            ...
            if (_atmospher == Atmospheres.BIOCHEMICAL_LAB)
            {
    ...
    private static unsafe void ProcessInput(WindowHandle* window)
    {
        ...
        if (_glfw.GetKey(window, Keys.Number1) == (int)InputAction.Press)
        {
            _atmospher = Atmospheres.DESERT;
        }
        if (_glfw.GetKey(window, Keys.Number2) == (int)InputAction.Press)
        {
            _atmospher = Atmospheres.FACTORY;
        }
        if (_glfw.GetKey(window, Keys.Number3) == (int)InputAction.Press)
        {
            _atmospher = Atmospheres.HORROR;
        }
        if (_glfw.GetKey(window, Keys.Number4) == (int)InputAction.Press)
        {
            _atmospher = Atmospheres.BIOCHEMICAL_LAB;
        }
    }

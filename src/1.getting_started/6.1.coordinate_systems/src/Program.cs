...
public class Program
{
    ...
    private unsafe static void Main(string[] args)
    {
        ...
        while (!_glfw.WindowShouldClose(window))
        {
            ...
            model *= Matrix4x4.CreateFromAxisAngle(Vector3.Normalize(new Vector3(1.0f, 0.0f, 0.0f)), MathHelper.DegreesToRadians(-55.0f));
            ...
            int modelLoc = _gl.GetUniformLocation(ourShader.ID, "model");
            int viewLoc = _gl.GetUniformLocation(ourShader.ID, "view");
